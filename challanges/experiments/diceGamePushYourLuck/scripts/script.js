...
//function to swap user used when person looses or holds
const switchTurn = () => {
    if (playersTurn == 1){
...
function rollDice (){
    ...
    //second try add background img
    // document.getElementById("imageOfDice").style.backgroundImage = `../images/${valueOfDice}.jpg`
